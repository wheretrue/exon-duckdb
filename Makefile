...
EXTENSION_NAME=EXON
EXTENSION_FLAGS=\
-DDUCKDB_EXTENSION_NAMES="exon" \
-DDUCKDB_EXTENSION_${EXTENSION_NAME}_PATH="$(PROJ_DIR)" \
-DDUCKDB_EXTENSION_${EXTENSION_NAME}_LOAD_TESTS=1 \
-DDUCKDB_EXTENSION_${EXTENSION_NAME}_INCLUDE_PATH="$(PROJ_DIR)exon/include" \
...
#### Client tests
DEBUG_EXT_PATH='$(PROJ_DIR)build/debug/extension/exon/exon.duckdb_extension'
RELEASE_EXT_PATH='$(PROJ_DIR)build/release/extension/exon/exon.duckdb_extension'
