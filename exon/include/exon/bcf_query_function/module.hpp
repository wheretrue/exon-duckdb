...
namespace exon
{
    ...
    struct BCFQueryTableScanInfo : public TableFunctionInfo
    {
    };

    struct BCFQueryTableFunction : duckdb::ArrowTableFunction
    {
    private:
        ...
        static unique_ptr<LocalTableFunctionState> BCFQueryScanInitLocalInternal(ClientContext &context,
                                                                                 TableFunctionInitInput &input,
                                                                                 GlobalTableFunctionState *global_state);

        static unique_ptr<LocalTableFunctionState> BCFQueryScanInitLocal(ExecutionContext &context,
                                                                         TableFunctionInitInput &input,
                                                                         GlobalTableFunctionState *global_state);
