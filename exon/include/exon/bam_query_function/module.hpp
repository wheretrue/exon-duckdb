...
namespace exon
{
    ...
    struct BAMQueryTableScanInfo : public TableFunctionInfo
    {
    };

    struct BAMQueryTableFunction : duckdb::ArrowTableFunction
    {
    private:
        ...
        static unique_ptr<LocalTableFunctionState> BAMQueryScanInitLocalInternal(ClientContext &context,
                                                                                 TableFunctionInitInput &input,
                                                                                 GlobalTableFunctionState *global_state);

        static unique_ptr<LocalTableFunctionState> BAMQueryScanInitLocal(ExecutionContext &context,
                                                                         TableFunctionInitInput &input,
                                                                         GlobalTableFunctionState *global_state);
